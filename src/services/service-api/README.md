...
The backend implements the Public 1.6.0 endpoint set for guest/session lifecycle,
...
Public 1.6.0 provides CSRF-protected email registration and login backed by
...
Public 1.6.0 currently has no authenticated artifact-download operation, so
