...
Public Service OpenAPI 1.5.0과 Private Routing OpenAPI 1.2.0에서 생성한 consumer artifacts다. Private request의 `contractVersion: "1.0"`은 1.x wire compatibility family로 유지한다.
