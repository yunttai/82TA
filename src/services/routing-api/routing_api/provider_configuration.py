...
PROVIDER_CREDENTIAL_SETTING_BY_OPERATION = MappingProxyType(
    {
        ...
        ("KAKAO_DIRECTIONS", "route_current"): "KAKAO_MOBILITY_REST_API_KEY",
        ("KAKAO_MULTI_DESTINATION", "many_destinations"): "KAKAO_MOBILITY_REST_API_KEY",
        ("KAKAO_MULTI_ORIGIN", "many_origins"): "KAKAO_MOBILITY_REST_API_KEY",
        ("KAKAO_FUTURE_DIRECTIONS", "route_future"): "KAKAO_MOBILITY_REST_API_KEY",
        ...
        ("KMA", "weather_context"): "KMA_SERVICE_KEY",
