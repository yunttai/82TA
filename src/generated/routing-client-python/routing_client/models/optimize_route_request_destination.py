...
T = TypeVar("T", bound="OptimizeRouteRequestDestination")


@_attrs_define
class OptimizeRouteRequestDestination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        optimize_route_request_destination = cls(
            coordinate=coordinate,
            region_hint=region_hint,
        )

        return optimize_route_request_destination
