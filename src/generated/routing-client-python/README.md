# routing-client-python
A client library for accessing Budget Route Routing & Intelligence API

## Usage
First, create a client:

```python
from routing_client import Client
...
```python
from routing_client import AuthenticatedClient
...
```python
from routing_client.models import MyDataModel
from routing_client.api.my_tag import get_my_data_model
from routing_client.types import Response
...
1. Any endpoint which did not have a tag will be in `routing_client.api.default`
